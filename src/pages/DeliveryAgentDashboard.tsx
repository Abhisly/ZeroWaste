    ...
    return (
        <div className="space-y-8">
            <div className="flex justify-between items-end">
                <div>
                    <h1 className="text-4xl font-display font-black tracking-tight text-white mb-2">Delivery Portal</h1>
                ...
                <div className="flex gap-4">
                    <div className="bg-white/5 border border-white/10 p-4 rounded-xl backdrop-blur-md">
                        <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">Today's Goal</p>
                        <p className="text-2xl font-black text-blue-400 font-mono">12/15 <span className="text-xs text-gray-600">KG</span></p>
                    </div>
                    <div className="bg-white/5 border border-white/10 p-4 rounded-xl backdrop-blur-md">
                        <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">Earnings</p>
                        <p className="text-2xl font-black text-green-400">$42.00</p>
                    </div>
                </div>
            </div>
                ...
                <div className="lg:col-span-2 space-y-8">
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex justify-between items-start mb-8">
                                        <div>
                                            <span className="text-[10px] font-black uppercase tracking-[0.2em] bg-white/20 px-3 py-1 rounded-full text-white mb-2 inline-block">
                                                Active Mission
                                            </span>
                                            <h2 className="text-3xl font-black text-white">In Progress Delivery</h2>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                                        <div className="space-y-4">
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div>
                                                    <p className="text-xs text-blue-100 uppercase font-black tracking-widest mb-1">Pickup From</p>
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div>
                                                    <p className="text-xs text-blue-100 uppercase font-black tracking-widest mb-1">Drop To</p>
                                        ...
                                        <div className="bg-black/20 rounded-2xl p-6 backdrop-blur-md">
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <p className="text-white font-black">{activeDelivery.type}</p>
                                                </div>
                                                <div>
                                                    <p className="text-[10px] text-blue-100 font-bold uppercase mb-1">Weight</p>
                                                    <p className="text-white font-black">{activeDelivery.quantity}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-white text-blue-600 py-5 rounded-2xl font-black text-lg shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3"
                                    >
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-xl font-black text-white">Available in your area</h3>
                        </div>
                            ...
                            {deliveries.map((d) => (
                                ...
                                >
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button className="p-3 rounded-xl border border-white/10 text-gray-500 hover:text-white hover:border-white/30 transition-all">
                ...
                <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <div className="p-4 rounded-2xl bg-black/40 border border-white/5 flex items-center justify-between">
                                <div className="flex items-center gap-3 text-left">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black text-gray-500 uppercase">Success Rate</p>
                            ...
                            <div className="p-4 rounded-2xl bg-black/40 border border-white/5 flex items-center justify-between">
                                <div className="flex items-center gap-3 text-left">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black text-gray-500 uppercase">Avg On-Time</p>
                    ...
                    <div className="bg-gradient-to-br from-white/5 to-white/0 border border-white/10 rounded-3xl p-8">
                        ...
                        <div className="space-y-3">
                            <button className="w-full py-4 rounded-xl bg-red-500/10 text-red-500 border border-red-500/20 font-black text-xs uppercase tracking-widest">
                                S.O.S Button
                            </button>
                            <button className="w-full py-4 rounded-xl bg-white/5 text-gray-400 font-bold text-xs uppercase tracking-widest">
                                Live Chat Support
                            </button>
                        </div>
                    </div>
